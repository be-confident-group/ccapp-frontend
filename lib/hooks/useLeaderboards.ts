...
export const leaderboardKeys = {
  ...
  list: (type: LeaderboardType, clubId?: number | null) =>
    [...leaderboardKeys.lists(), type, clubId] as const,
 ...
 */
export function useLeaderboard(type: LeaderboardType, clubId?: number | null) {
  return useQuery({
    queryKey: leaderboardKeys.list(type, clubId),
    queryFn: () =>
